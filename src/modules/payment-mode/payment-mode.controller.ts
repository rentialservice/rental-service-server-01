...
export class PaymentModeController {
  ...
  async create(
    ...
    @Body() createObject: Partial<PaymentMode>,
  ): Promise<void> {
    try {
  ...
  async getFilter(
    ...
    try {
      const result: any = await this.paymentModeService.filter(
        request.query,
        [],
        filterType,
      );
  ...
  async getAll(
    ...
    try {
      const [result, count]: any = await this.paymentModeService.getAll(
        page,
        pageSize,
        filterType,
      );
  ...
  async update(
    ...
    try {
      let result = await this.paymentModeService.update(
        id,
        updateObject,
        filterType,
      );
