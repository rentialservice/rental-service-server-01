...
export class PaymentModeService {
    ...
    async getById(id: string, filterType?: string): Promise<any> {
        const paymentMode = await this.paymentModeRepository.findOne({ where: { id, deleteFlag: false } });
        if (!paymentMode) {
    ...
    async update(id: string, updateObject: Partial<PaymentMode>, filterType?: string): Promise<any> {
