...
export class PrefixController {
  ...
  async create(
    ...
    @Body() createObject: Partial<Prefix>,
  ): Promise<void> {
    try {
  ...
  async getAll(
    ...
    try {
      const [result, count]: any = await this.prefixService.getAll(
        page,
        pageSize,
        filterType,
  ...
  async update(
    ...
    try {
      let result = await this.prefixService.update(
        id,
        updateObject,
        filterType,
      );
  ...
  async filter(
    ...
    try {
      const result: any = await this.prefixService.filter(
        filterCriteria,
        [],
        filterType,
      );
