...
export class RentalProductController {
    ...
    async create(
        ...
        @Body() createObject: Partial<RentalProduct[]>): Promise<void> {
        try {
    ...
    async getFilter(
        ...
        try {
            const result: any = await this.rentalProductService.filter(request.query, [], filterType);
            successResponse(response, result);
        } catch (error: any) {
            errorResponse(response, error);
        }
    ...
    async getAll(
        ...
        try {
            const [result, count]: any = await this.rentalProductService.getAll(page, pageSize, filterType);
    ...
    async update(
        ...
        try {
            let result = await this.rentalProductService.update(id, updateObject, filterType);
            successResponse(response, result);
        } catch (error: any) {
            errorResponse(response, error);
        }
    ...
    async filter(
        ...
        try {
            const result: any = await this.rentalProductService.filter(filterCriteria, [], filterType);
            successResponse(response, result);
        } catch (error: any) {
            errorResponse(response, error);
        }
