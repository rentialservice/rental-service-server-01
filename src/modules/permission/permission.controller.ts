...
export class PermissionController {
    ...
    async create(
        ...
        @Body() createObject: Partial<Permission>): Promise<void> {
        try {
    ...
    async getAll(
        ...
        try {
            const [result, count]: any = await this.permissionService.getAll(page, pageSize, filterType);
    ...
    async update(
        ...
        try {
            let result = await this.permissionService.update(id, updateObject, filterType);
            successResponse(response, result);
        } catch (error: any) {
            errorResponse(response, error);
        }
    ...
    async updateActionById(
        ...
        try {
            let result = await this.permissionService.updateActionById(id, action, filterType);
            successResponse(response, result);
        } catch (error: any) {
            errorResponse(response, error);
        }
